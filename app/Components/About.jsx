      ...
      <div className="max-w-7xl mx-auto">
        ...
        >
          ...
          <div className="flex-1">
            ...
            {/* Stats bar */}
            <div className="grid grid-cols-2 sm:grid-cols-3 gap-4 my-6 py-4 border-t border-b border-gray-200 dark:border-gray-700 w-full max-w-2xl">
              {stats.map((stat, i) => (
                <div key={i} className="text-left flex flex-col justify-center">
                  ...
                  <p className="text-[10px] sm:text-xs text-gray-500 dark:text-gray-400 mt-1.5 leading-tight">
                    {stat.label}
                  </p>
                </div>
              ))}
            ...
            {content.cards.map((card, index) => {
              ...
              return (
                ...
                >
                  ...
                  <h3 className="my-4 font-bold text-xl text-gray-800 dark:text-white">
                    {card.title}
                  </h3>
