...
const Footer = ({isDarkMode, setIsDarkMode}) => {
  return (
    <div className='w-full bg-gray-900 text-gray-300 py-16 px-4 sm:px-6 lg:px-[8%]'>
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-12 mb-12">
          ...
          <div className="lg:col-span-1">
            <div className="mb-6">
              <span className="text-2xl font-bold text-white">Md Shakil Hossen</span>
            </div>
            <p className="mb-6 max-w-xs">
              Full suite of premium services in Data Analysis, SEO, and Web Development.
            </p>
            <div className="flex items-center gap-3">
              <Image src={assets.mail_icon} alt='Email' className='w-5 h-5' />
              <span>being.shakill@gmail.com</span>
            </div>
          </div>
        ...
        <div className="pt-8 border-t border-gray-800 text-center">
          <p>&copy; {new Date().getFullYear()} Md Shakil Hossen. All rights reserved.</p>
        </div>
      </div>
    </div>
  )
